<template>
  <section id="features">
    <h2>Note</h2>
    <p>
      [Aerya] J’ai forké le travail de Viren070, car personne jusqu’ici n’avait eu l’idée de publier une image Docker pour simplifier le déploiement de cet outil.<br><br><br>
